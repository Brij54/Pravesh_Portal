 ...
 */
@Component
 public class UserRoundMap extends BaseResource {
	...
	public static String FIELD_ROUND_ID = "round_id";
	public static String FIELD_EXTRA_DATA = "extra_data";

	private static final long serialVersionUID = 1L;
	public final static ResourceMetaData metaData = new ResourceMetaData("user_round_map");
	...
	static {
		...
		Field round_idField = new Field("round_id", "String");
		round_idField.setRequired(true);
		round_idField.setForeign(new Foreign("Rounds"));
		metaData.addField(round_idField);
		...
		metaData.setTableName("user_round_map");

		metaData.setCluster("rasp_db");
	}

	public UserRoundMap() {this.setId(Util.getUniqueId());}
	public UserRoundMap(String id) {this.setId(id);}

	public UserRoundMap(UserRoundMap obj) {
		this.id = obj.id;
	...
	public void convertMapToResource(Map<String, Object> map) {
		...
		round_id = (String) map.get("round_id");
	...
	public void convertTypeUnsafeMapToResource(Map<String, Object> map) {
		...
		Object round_idObj = map.get("round_id");
		if(round_idObj != null)
			round_id = round_idObj.toString();
	...
	public String getRound_idEx() {
		return round_id != null ? round_id : "";
	}
	...
	public boolean validateRound_id(boolean add) throws ApplicationException {
		if(add && round_id == null)
			throw new ApplicationException(ExceptionSeverity.ERROR, "Requierd validation Failed[round_id]");
		return round_id != null;
	}
	...
	public  Class<?> getResultClass() {return UserRoundMapResult.class;};
	public  Class<?> getMessageClass() {return UserRoundMapMessage.class;};
	public  Class<?> getHelperClass() {return UserRoundMapHelper.class;};
	public  Class<?> getServiceClass() {return UserRoundMapService.class;};
}