 ...
 */
@Component
 public class Rounds extends BaseResource {
	...
	public static String FIELD_DRIVE_ID = "drive_id";
	public static String FIELD_EXTRA_DATA = "extra_data";

	private static final long serialVersionUID = 1L;
	public final static ResourceMetaData metaData = new ResourceMetaData("rounds");
	...
	static {
		...
		Field drive_idField = new Field("drive_id", "String");
		drive_idField.setRequired(true);
		drive_idField.setForeign(new Foreign("Drive"));
		metaData.addField(drive_idField);
		...
		metaData.setTableName("rounds");

		metaData.setCluster("rasp_db");
	}

	public Rounds() {this.setId(Util.getUniqueId());}
	public Rounds(String id) {this.setId(id);}

	public Rounds(Rounds obj) {
		this.id = obj.id;
	...
	public Map<String, Object> validateAndConvertResourceToMap(HashMap<String,Object> map,boolean add) throws ApplicationException {
		...
		if(validateEnddate(add))
			map.put("enddate", enddate);
		if(validateDetails(add))
			map.put("details", details);
		if(validateDrive_id(add))
			map.put("drive_id", drive_id);
		if(extra_data != null)
			map.put("extra_data", extra_data);
		return map;
	...
	public void convertMapToResource(Map<String, Object> map) {
		...
		drive_id = (String) map.get("drive_id");
	...
	public void convertTypeUnsafeMapToResource(Map<String, Object> map) {
		...
		Object drive_idObj = map.get("drive_id");
		if(drive_idObj != null)
			drive_id = drive_idObj.toString();
	...
	public boolean validateDetails(boolean add) throws ApplicationException {
		if(add && details == null)
			throw new ApplicationException(ExceptionSeverity.ERROR, "Requierd validation Failed[details]");
		return details != null;
	}
	...
	public String getDrive_idEx() {
		return drive_id != null ? drive_id : "";
	}
	...
	public void unSetDrive_id() {
		this.drive_id = null;
	}

	public boolean validateDrive_id(boolean add) throws ApplicationException {
		if(add && drive_id == null)
			throw new ApplicationException(ExceptionSeverity.ERROR, "Requierd validation Failed[drive_id]");
	...
	public  Class<?> getResultClass() {return RoundsResult.class;};
	public  Class<?> getMessageClass() {return RoundsMessage.class;};
	public  Class<?> getHelperClass() {return RoundsHelper.class;};
	public  Class<?> getServiceClass() {return RoundsService.class;};
}