 ...
 */
@Component
 public class UserDriveMap extends BaseResource {
	...
	public final static ResourceMetaData metaData = new ResourceMetaData("user_drive_map");
	...
	static {
		...
		metaData.setTableName("user_drive_map");

		metaData.setCluster("rasp_db");
	}

	public UserDriveMap() {this.setId(Util.getUniqueId());}
	public UserDriveMap(String id) {this.setId(id);}

	public UserDriveMap(UserDriveMap obj) {
		this.id = obj.id;
	...
	public  Class<?> getResultClass() {return UserDriveMapResult.class;};
	public  Class<?> getMessageClass() {return UserDriveMapMessage.class;};
	public  Class<?> getHelperClass() {return UserDriveMapHelper.class;};
	public  Class<?> getServiceClass() {return UserDriveMapService.class;};
}